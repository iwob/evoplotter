...
def create_subsection_custom_tables(props, title, EXP_TYPE,  dimensions_dict, results_dir, variants=None):
    ...
    tables = [
        ...
        FriedmannTestPython(dimensions_dict["benchmark"],
                            ...
                            pathFriedmanViz=results_dir + "/tables/custom/friedman_all.gv"),
        FriedmannTestPython(dimensions_dict["benchmark"],
                            ...
                            pathFriedmanViz=results_dir + "/tables/custom/friedman_generational.gv"),
        FriedmannTestPython(dimensions_dict["benchmark"],
                            ...
                            pathFriedmanViz=results_dir + "/tables/custom/friedman_steadyState.gv"),
        TableGenerator(fun_successRate,
        ...
        FriedmannTestPython(dimensions_dict["benchmark"],
                            ...
                            pathFriedmanViz=results_dir + "/tables/custom/friedman_testsRatio.gv"),
    ]
